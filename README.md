...
_Поиск->Система->Дополнительные параметры системы->Параметры среды->Системные переменные->Path->Изменить_
...
_Проекты->Управление->Профили Qt->Добавить_
...
_Проекты->Управление->Комплекты->Добавить_
